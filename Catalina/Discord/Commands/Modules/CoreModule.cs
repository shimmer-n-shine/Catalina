...
public async Task Say([ComplexParameter] EmbedParameter embed = null)
{
    ...
    try
    {
        ...
        await Context.Interaction.RespondAsync(embed: new Utils.InformationMessage(Context.User) { Body = "Creating message on your behalf." }, ephemeral: true);
...
public class EmbedParameter
    {
        ...
        public EmbedParameter(string title = "", string description = "", [Autocomplete(typeof(ColourNames))] string color = "", string imageUrl = null)
        {
            ...
            this.Color = colours.TryGetValue(color, out var value) ? value : CatalinaColours.None;
